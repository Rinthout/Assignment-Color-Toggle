...
homeButton.addEventListener('click', function () {
    ...
    document.getElementById("home-radio").addEventListener("click", hamburgerMenu);
...
redButton.addEventListener('click', function () {
    ...
    document.getElementById("red-radio").addEventListener("click", hamburgerMenu);
...
orangeButton.addEventListener('click', function () {
    ...
    document.getElementById("orange-radio").addEventListener("click", hamburgerMenu);
...
purpleButton.addEventListener('click', function () {
    ...
    document.getElementById("purple-radio").addEventListener("click", hamburgerMenu);
...
greenButton.addEventListener('click', function () {
    ...
    document.getElementById("green-radio").addEventListener("click", hamburgerMenu);
